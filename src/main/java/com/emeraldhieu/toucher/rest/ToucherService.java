...
public class ToucherService {
    ...
    private final TouchProcessor touchProcessor = new TouchProcessor();
            ...
            try (
                ...
                CompletableFuture<Void> writeZipFuture = CompletableFuture.runAsync(() -> {
                    try {
                        ...
                        writeToZipOutputStream(pipedFailureInputStream, zipOutputStream, "failure.csv");
                        writeToZipOutputStream(pipedSummaryInputStream, zipOutputStream, "summary.csv");
                    } catch (IOException e) {
